...
import { Plus, Save, Table, UserCheck, XCircle, CheckCircle2, ListChecks, Download, Settings2, Trash2, X, AlertCircle, ChevronDown, ChevronRight, Calculator, GripVertical, Calendar, School, Info } from 'lucide-react';
...
export const Grades: React.FC<GradesProps> = ({ students, classes, years, records, setRecords, grades, scoreColumns, currentUser }) => {
                        ...
                        {processedStudentsYear.length > 0 ? (
                            processedStudentsYear.map((s, idx) => {
                                ...
                                <tr key={s.id} className="hover:bg-blue-50/20 group transition-colors border-b border-slate-200 text-sm">
                                    ...
                                    <td className="px-4 py-2 sticky left-[40px] bg-white group-hover:bg-slate-50 z-40 border-r border-slate-400 shadow-[2px_0_4px_rgba(0,0,0,0.1)]">
